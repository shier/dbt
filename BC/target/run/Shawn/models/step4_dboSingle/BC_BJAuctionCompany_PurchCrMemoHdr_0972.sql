  ...
  if object_id ('"dbo"."BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp_temp_view"','V') is not null
    begin
    drop view "dbo"."BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp_temp_view"
    end


   
    
  if object_id ('"dbo"."BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp"','U') is not null
    begin
    drop table "dbo"."BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp"
    end


   EXEC('create view dbo.BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp_temp_view as
...
From stg.[BC_BJAuctionCompany_PurchCrMemoHdr_0972_FinalView]
  ...
  CREATE TABLE "dbo"."BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp"
    WITH(
      DISTRIBUTION = ROUND_ROBIN,
      CLUSTERED COLUMNSTORE INDEX
      )
    AS (SELECT * FROM dbo.BC_BJAuctionCompany_PurchCrMemoHdr_0972__dbt_tmp_temp_view)
