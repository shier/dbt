  ...
  if object_id ('"stg"."Auct_Customer_Archive_BR_Step2__dbt_tmp_temp_view"','V') is not null
    begin
    drop view "stg"."Auct_Customer_Archive_BR_Step2__dbt_tmp_temp_view"
    end


   
    
  if object_id ('"stg"."Auct_Customer_Archive_BR_Step2__dbt_tmp"','U') is not null
    begin
    drop table "stg"."Auct_Customer_Archive_BR_Step2__dbt_tmp"
    end


   EXEC('create view stg.Auct_Customer_Archive_BR_Step2__dbt_tmp_temp_view as
...
-- Auct_CA_Auct_Customer_CTE1
    ...
    INNER JOIN stg.[Auct_Customer_Archive_BR_Step1] vdrstg 
  ...
  CREATE TABLE "stg"."Auct_Customer_Archive_BR_Step2__dbt_tmp"
    WITH(
      DISTRIBUTION = ROUND_ROBIN,
      CLUSTERED COLUMNSTORE INDEX
      )
    AS (SELECT * FROM stg.Auct_Customer_Archive_BR_Step2__dbt_tmp_temp_view)
