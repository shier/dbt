  ...
  if object_id ('"stg"."Auct_CA_Temp1__dbt_tmp_temp_view"','V') is not null
    begin
    drop view "stg"."Auct_CA_Temp1__dbt_tmp_temp_view"
    end


   
    
  if object_id ('"stg"."Auct_CA_Temp1__dbt_tmp"','U') is not null
    begin
    drop table "stg"."Auct_CA_Temp1__dbt_tmp"
    end


   EXEC('create view stg.Auct_CA_Temp1__dbt_tmp_temp_view as
            ...
            FROM stg.Auct_CA_Auct_Customer_CTE1 cxstg1
  ...
  CREATE TABLE "stg"."Auct_CA_Temp1__dbt_tmp"
    WITH(
      DISTRIBUTION = ROUND_ROBIN,
      CLUSTERED COLUMNSTORE INDEX
      )
    AS (SELECT * FROM stg.Auct_CA_Temp1__dbt_tmp_temp_view)
