  ...
  if object_id ('"stg"."Auct_Reporting_Incr"','U') is not null
   ...
   EXEC('create view stg.Auct_Reporting_Incr_temp_view as
    ...
    CONVERT(VARCHAR(32), HashBytes(''MD5'', 
        ...
        coalesce(cast(CONVERT(DATETIME2, ''2022-08-24 12:50:20.384486'') as varchar(max)), '''') 
    ), 2)
 as dbt_scd_id,
        CONVERT(DATETIME2, ''2022-08-24 12:50:20.384486'') as dbt_updated_at,
        CONVERT(DATETIME2, ''2022-08-24 12:50:20.384486'') as dbt_valid_from,
        nullif(CONVERT(DATETIME2, ''2022-08-24 12:50:20.384486''), CONVERT(DATETIME2, ''2022-08-24 12:50:20.384486'')) as dbt_valid_to
    from (
