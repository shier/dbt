      ...
      EXEC('
           BEGIN TRANSACTION
           update "DedicatedSQLpoolBJ"."stg"."CC_ReSourceGUIDE_Incr"
          set dbt_valid_to = TMP.dbt_valid_to
          from "DedicatedSQLpoolBJ"."stg"."#CC_ReSourceGUIDE_Incr__dbt_tmp" TMP
          where "DedicatedSQLpoolBJ"."stg"."CC_ReSourceGUIDE_Incr".dbt_scd_id = TMP.dbt_scd_id
            and TMP.dbt_change_type in (''update'', ''delete'')
            and "DedicatedSQLpoolBJ"."stg"."CC_ReSourceGUIDE_Incr".dbt_valid_to is null;

            insert into "DedicatedSQLpoolBJ"."stg"."CC_ReSourceGUIDE_Incr" (
            ...
            from "DedicatedSQLpoolBJ"."stg"."#CC_ReSourceGUIDE_Incr__dbt_tmp" 
