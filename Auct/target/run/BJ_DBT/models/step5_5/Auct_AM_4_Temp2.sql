  ...
  if object_id ('"stg"."Auct_AM_4_Temp2__dbt_tmp_temp_view"','V') is not null
    begin
    drop view "stg"."Auct_AM_4_Temp2__dbt_tmp_temp_view"
    end


   
    
  if object_id ('"stg"."Auct_AM_4_Temp2__dbt_tmp"','U') is not null
    begin
    drop table "stg"."Auct_AM_4_Temp2__dbt_tmp"
    end


   EXEC('create view stg.Auct_AM_4_Temp2__dbt_tmp_temp_view as
    

With idList as (
    select * from stg.Auct_AM_NullList
),temp1 as (
                SELECT 
                ...
                LEFT JOIN stg.[Auct_AM_3_First_Spotted_Address_Merged] firstspotted 
 ...
 SELECT
  ...
  CREATE TABLE "stg"."Auct_AM_4_Temp2__dbt_tmp"
    WITH(
      DISTRIBUTION = ROUND_ROBIN,
      CLUSTERED COLUMNSTORE INDEX
      )
    AS (SELECT * FROM stg.Auct_AM_4_Temp2__dbt_tmp_temp_view)
