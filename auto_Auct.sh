...
dbt run --project-dir Auct --select step5_Address_Merge/Auct_AM_4_Address_Merged1.sql
...
dbt run --project-dir Auct --select step7_afterLookup/Auct_CA_2_Temp2.sql
